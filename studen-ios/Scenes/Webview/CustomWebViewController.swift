...
class CustomWebViewController: UIViewController {
    ...
    private lazy var viewModel: CustomWebViewModelType = CustomWebViewModel()
...
extension CustomWebViewController: WKUIDelegate, WKNavigationDelegate {
...
extension CustomWebViewController: AppodealRewardedVideoDelegate {
...
extension CustomWebViewController: ApphudDelegate {
